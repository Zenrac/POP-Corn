...
<html>
	<body>
		...
		<?php
			...
			echo "<input id='recherchebutton' type='submit' name='Rechercher' value='Rechercher'/>";
			echo "</form></div></div>";


				echo "<a href='".get_path('pages/avance.php')."'>Faire une recherche avancé ?</a>";
				...
				if (!empty($_POST['Rechercher']))
				{
					...
					else if ($nblignes2 == 1)
					{
						...
						$elems = $req->fetchAll();
						$donnees = $elems[0];
						echo "Pour l'auteur : ".$_POST['barre'].", Voici les chansons écritent : <br />";
						...
						$donnees = $elems[0];
						$numMusique = $donnees['numMusique'];
						echo "<a href='".get_path('pages/music.php?id='.$numMusique)."'>".$donnees['titre']."</a>";
					}
					else if ($nblignes3 == 1)
					{
